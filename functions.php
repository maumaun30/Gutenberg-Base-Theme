 ...
 *
 * Overlay markup output near the end of <body>. Behaviour (open/close, phone
 * validation, attribution redirect) lives in assets/js/register-modal.js;
 * any element with the class `fm-open-register` opens it.
 */
function fnlmx_register_modal() {
  ?>
  <!-- ── Register / Sign Up Modal ── -->
...
add_action( 'wp_footer', 'fnlmx_register_modal' );
