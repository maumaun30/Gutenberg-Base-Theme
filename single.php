...
<style>
  ...
  .sp-fg__btn:disabled svg,
  .sp-fg__btn.swiper-button-disabled svg {
    fill: none;
    stroke: #7C7C7C;
  }
...
<div class="sp-page">
  ...
  <div class="sp-main<?php echo empty($related_posts) ? ' sp-main--full' : ''; ?>">
    ...
    <?php if (! empty($related_posts)) : ?>
      <aside class="sp-side">
        <h2 class="sp-side__hd">Recent Blogs</h2>
  ...
  <?php if (! empty($featured_games)) : ?>
    <section class="sp-fg">
      <div class="sp-fg__hd-row">
        <h2 class="sp-fg__hd">Featured Games</h2>
        <div class="sp-fg__nav">
          <button type="button" class="sp-fg__btn sp-fg__prev" aria-label="Previous">
            <svg viewBox="0 0 8 12" xmlns="http://www.w3.org/2000/svg">
              <polyline points="6,1 1.5,6 6,11" />
            </svg>
          </button>
          <button type="button" class="sp-fg__btn sp-fg__next" aria-label="Next">
            <svg viewBox="0 0 8 12" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="swiper sp-fg__swiper">
        <div class="swiper-wrapper">
          <?php foreach ($featured_games as $g) : ?>
            <div class="swiper-slide">
              <a class="sp-fg__card" href="<?php echo esc_url($g['permalink']); ?>" title="<?php echo esc_attr($g['title']); ?>">
                <?php if ($g['thumb']) : ?>
  ...
  <!-- CTA -->
  <div class="sp-cta-wrap"><?php echo do_shortcode('[fnlmx_cta]'); ?></div>
